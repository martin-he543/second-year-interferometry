...
ig_peak1 = [7.12e8,577.121,0.1,0]
ig_peak2 = [7.44e8,583.97 - 4.7,0.1,0]
...
percentage_peak1 = 100*ig_peak1[0]/ig_peak2[0]
percentage_peak2 = 100*ig_peak2[0]/ig_peak2[0]
...
plt.xlim(576,580)
plt.ylim(0, 0.1e10)
plt.savefig("output_"+file+"_zoomed.png", dpi=1000)
plt.show()