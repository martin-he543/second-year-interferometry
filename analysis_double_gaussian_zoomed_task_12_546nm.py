...
vals1 = np.linspace(542, 550, 1000)
...
plt.plot(new_x_data - 0.3 ,new_y_data, label='After Shifting and Cubic-Spline\nN = 1 × 10⁷, Entire Hg Spectrum')
plt.plot(vals1, gaussian(vals1, *ig_peak1), 'r-', label='Gaussian ≅ 546nm')
...
plt.annotate('local maximum at ≅ 546nm', xy=(ig_peak1[1] - 0.1, ig_peak1[0]-0.3e9), xytext=(ig_peak1[1] - 0.1, ig_peak1[0]-0.3e9) , rotation=90, **annotationFont)
...
plt.savefig("output_" + file + "_zoomed_546nm.png", dpi=1000)
plt.show()
