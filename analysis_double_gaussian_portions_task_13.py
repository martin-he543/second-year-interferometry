...
spectral_lines = [4046.563e-1,4339.223e-1,4347.494e-1,4358.328e-1,5128.442e-1,5204.768e-1,5460.735e-1,5769.598e-1,5790.663e-1,6146.435e-1,6149.475e-1,7081.90e-1,7346.508e-1,7944.555e-1,9520.198e-1]
...
actual_lines = [4046.563e-1,4339.223e-1,4347.494e-1,4358.328e-1,5128.442e-1,5204.768e-1,5460.220e-1,5767.671e-1,5790.185e-1,6146.435e-1,6149.475e-1,7081.90e-1,7346.508e-1,7944.555e-1,9520.198e-1]
...
plt.plot(abs(repx1) - 4.7,abs(yf1[int(len(xf1)/2+1):len(xf1)]),label='After Shifting and Cubic-Spline\nN=%i, Full Hg'%(N))
...
new_x_data = abs(repx1) - 4.7

ig_peak1 = [7.11e8,577.116,0.1,0]
ig_peak2 = [7.47e8,579.278,0.2,0]
ig_peak3 = [4.12527e9,546.0201,0.25,0]
...
plt.plot(vals3, gaussian(vals3, *ig_peak3), 'r-', label='Third Gaussian ≅ 546nm', color="orange")

plt.axvline(x=ig_peak1[1], color='red', linestyle='--', **lineStyle)
plt.annotate('local maximum at ≅ 577nm', xy=(ig_peak1[1] - 0.1, ig_peak1[0]), xytext=(ig_peak1[1] - 0.1, ig_peak1[0]) , rotation=90, **annotationFont)
...
plt.annotate('local maximum at ≅ 546nm', xy=(ig_peak3[1], ig_peak3[0]-8.75e9), xytext=(ig_peak3[1], ig_peak3[0]-9e9), rotation=90, **annotFontWeak)
plt.axhline(new_y_data[np.argmax(new_y_data)], color='orange', linestyle='--', **lineStyle)
plt.annotate("\t\t\t\t\t%.2f%% of Max Peak"%(100), xy=(ig_peak3[1] , new_y_data[np.argmax(new_y_data)]), xytext=(ig_peak3[1], new_y_data[np.argmax(new_y_data)]), **annotFontWeak)
