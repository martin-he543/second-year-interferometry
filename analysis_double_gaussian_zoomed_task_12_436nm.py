...
vals1 = np.linspace(431, 439, 1000)
...
plt.plot(vals1, gaussian(vals1, *ig_peak1), 'r-', label='Gaussian ≅ 436nm')
...
plt.annotate('local maximum at ≅ 436nm', xy=(ig_peak1[1] - 0.1, ig_peak1[0]-0.3e9), xytext=(ig_peak1[1] - 0.1, ig_peak1[0]-0.3e9) , rotation=90, **annotationFont)
...
plt.savefig("output_" + file + "_zoomed_436nm.png", dpi=1000)
plt.show()
