...
plt.plot(abs(repx1)- 4.5845 + 0.1,2.41545*abs(yf1[int(len(xf1)/2+1):len(xf1)])/1e10,color='black',label='Post-Shifting and Cubic-Spline Interpolation\nfor N=%i, Full Hg'%(N))
...
plt.xlim(434,438)
plt.ylim(0, 0.8)
plt.savefig("output_"+file+"_436nm.png", dpi=1000)
plt.show()