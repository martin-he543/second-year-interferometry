...
plt.figure("Fully-Corrected Spectrum FFT", figsize=(5,5))
...
if mid:
    ...
    plt.annotate('local maximum at λ ≈ %.2f nm'%(spectral_lines[0]), xy=(spectral_lines[0], 0.1), xytext=(spectral_lines[0], 0.1) , rotation=90, bbox=dict(boxstyle="square, pad=0.5", fc="#f4dadf", ec="k", lw=0.5, alpha=0.1), **annotFontMini1)
    delta_percentage = abs(spectral_lines[0]-actual_lines[0])/spectral_lines[0]
    plt.annotate('Δλ ≅ %.4f%%'%(delta_percentage), xy=(spectral_lines[0], 0), xytext=(spectral_lines[0], 0) , rotation=90, **annotFontMini1, bbox=dict(boxstyle="square, pad=0.5", fc="#f9ffff", ec="k", lw=0.5, alpha=0.1))
    # 434 I
    ...
    plt.annotate('local maximum at λ ≈ %.2f nm'%(spectral_lines[3]), xy=(spectral_lines[3], 0.3), xytext=(spectral_lines[3], 0.3) , rotation=90, bbox=dict(boxstyle="square, pad=0.5", fc="#f4dadf", ec="k", lw=0.5, alpha=0.1), **annotFontMini1)
    delta_percentage = abs(spectral_lines[3]-actual_lines[3])/spectral_lines[3]
    plt.annotate('Δλ ≅ %.4f%%'%(delta_percentage), xy=(spectral_lines[3], 0.1), xytext=(spectral_lines[3], 0.1) , rotation=90, **annotFontMini1, bbox=dict(boxstyle="square, pad=0.5", fc="#f9ffff", ec="k", lw=0.5, alpha=0.1))
    # 546
    ...
    plt.annotate('local maximum at λ ≈ %.2f nm'%(spectral_lines[5]), xy=(spectral_lines[5], 0.15), xytext=(spectral_lines[5], 0.15) , rotation=90, bbox=dict(boxstyle="square, pad=0.5", fc="#f4dadf", ec="k", lw=0.5, alpha=0.1), **annotFontMini1)
    delta_percentage = abs(spectral_lines[5]-actual_lines[5])/spectral_lines[5]
    plt.annotate('Δλ ≅ %.4f%%'%(delta_percentage), xy=(spectral_lines[5], 0.05), xytext=(spectral_lines[5], 0.05) , rotation=90, **annotFontMini1, bbox=dict(boxstyle="square, pad=0.5", fc="#f9ffff", ec="k", lw=0.5, alpha=0.1))
    # 579
    plt.axvline(x=spectral_lines[6], color="red", linestyle='--', **lineStyle)
    plt.annotate('local maximum at λ ≈ %.2f nm'%(spectral_lines[6]), xy=(spectral_lines[6], 0.15), xytext=(spectral_lines[6], 0.15) , rotation=90, bbox=dict(boxstyle="square, pad=0.5", fc="#f4dadf", ec="k", lw=0.5, alpha=0.1), **annotFontMini1)
    delta_percentage = abs(spectral_lines[6]-actual_lines[6])/spectral_lines[6]
    plt.annotate('Δλ ≅ %.4f%%'%(delta_percentage), xy=(spectral_lines[6], 0.05), xytext=(spectral_lines[6], 0.05) , rotation=90, **annotFontMini1, bbox=dict(boxstyle="square, pad=0.5", fc="#f9ffff", ec="k", lw=0.5, alpha=0.1))
...
ig_peak4 = [2.91881e9-1.5e7,435.71275 + 0.1,0.05,1.5e7]
...
ig_peak5 = [5.09600e8-1.5e7,404.55267 + 0.1,0.05,1.5e7]
...
plt.plot(new_x_data[8008:] + 0.1,2.41545*(new_y_data[8008:] - 0.4e8)/1e10,color='black')
...
plt.annotate("\t\t\t\t\t%.2f%% of Max Peak"%(percentage_peak1), xy=(ig_peak1[1], 2.41545*ig_peak1[0]/1e10), xytext=(ig_peak1[1], 2.41545*ig_peak1[0]/1e10), **annotFontWeak)
plt.axhline(2.41545*ig_peak2[0]/1e10, color='green', linestyle='--', **lineStyle)
plt.annotate("\t\t\t\t\t%.2f%% of Max Peak"%(percentage_peak2), xy=(ig_peak1[1], 2.41545*ig_peak2[0]/1e10), xytext=(ig_peak2[1], 2.41545*ig_peak2[0]/1e10), **annotFontWeak)
...
plt.xlim(402,406)
plt.ylim(0, 0.2)
plt.savefig("output_"+file+"_404nm.png", dpi=1000)
plt.show()