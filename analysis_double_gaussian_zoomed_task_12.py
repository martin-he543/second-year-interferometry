...
ig_peak1 = [1.6865e9 - 5e7,576.767,0.2,5e7]
...
plt.annotate('local maximum at ≅ 577nm', xy=(ig_peak1[1] - 0.1, ig_peak1[0]-0.3e9), xytext=(ig_peak1[1] - 0.1, ig_peak1[0]-0.3e9) , rotation=90, **annotationFont)
